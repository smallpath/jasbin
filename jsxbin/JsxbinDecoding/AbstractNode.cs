...
namespace jsxbin_to_jsx.JsxbinDecoding
{
    public abstract class AbstractNode : INode
    {
        ...
        private static readonly Regex ExcludeIdentifier = new Regex("\0(?!0|1|2|3|4|5|6|7)");
        private static readonly Regex IncludeIdentifier = new Regex("\0(?=0|1|2|3|4|5|6|7)");
        ...
        {
            return !javascriptKeywords.Contains(identifier) && ValidIdentifier.IsMatch(identifier);
        }
        ...
        public string DecodeId()
        {
            ...
            else
            {
                ...
                var name = SanitizeString(DecodeString());
                var id = DecodeLength().ToString();
       ...
       public string SanitizeString(string value)
        {
            return IncludeIdentifier.Replace(ExcludeIdentifier.Replace(value
                .Replace("\\", "\\\\")
                .Replace("\"", "\\\"")
                .Replace("\n", "\\n")
                .Replace("\r", "\\r")
        ...
        public string DecodeLiteral(bool isNumber, bool isUnicodeString)
        {
            ...
            if (IsNested()&& isUnicodeString == false)
            {
                DecrementNesting();
                return null;
            }
